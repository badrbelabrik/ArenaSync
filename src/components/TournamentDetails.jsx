                ...
                <div className="details-tournament-card">
                    <div className="details-tournament-card-header">
                        ...
                        <div className="details-tournament-card-header-flex">
                            <p className="details-tournament-card-header-title">{tournament.title}</p>
                    ...
                    <div className="details-tournament-card-rules">
                        <div className="details-tournament-card-rule"><i className="fa-solid fa-users"></i> <p>{tournament.participantsCount.current}/{tournament.participantsCount.max} Participants - {tournament.visibility}</p></div>
                        <div className="details-tournament-card-rule"><i className="fa-solid fa-trophy"></i> <p>{tournament.format}</p></div>
                        <div className="details-tournament-card-rule"><i className="fa-solid fa-clipboard-list"></i> <p>{tournament.date}</p></div>
                        <div className="details-tournament-card-rule"><i className="fa-solid fa-location-dot"></i> <p>{tournament.location}</p></div>
                    </div>
                </div>
                <Tabsystem />
            </div>
